...
<x-MenuUser>
    <div class="container mt-5">
        ...
        <form id="editProductForm" class="needs-validation" action="{{ url('update-productoUser/'.$key) }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-center">
                ...
                <a href="{{ url('productosUser') }}" class="btn btn-secondary">Cancelar</a> 
                <a href="{{ url('productosUser') }}" class="btn btn-sm btn-danger ">Volver</a> 
