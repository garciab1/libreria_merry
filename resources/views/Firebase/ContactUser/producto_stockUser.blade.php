                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="productTableBody">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('edit-productoUser/'.$key)}}" class="btn btn-warning btn-sm rounded-circle" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <span style="margin: 0 5px;"></span>
                                    <a href="{{url('delete-productoUser/'.$key)}}" class="btn btn-danger btn-sm rounded-circle" title="Eliminar">
